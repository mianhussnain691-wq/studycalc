...
function removeSemester(id) {
  ...
  setSemesters(
    semesters.filter((semester) => semester.id !== id)
  );
}
...
<button
  ...
  className="rounded-xl bg-red-500 px-4 py-4 font-bold hover:bg-red-600 transition"
>
  ✕
</button>
...
<div className="mt-8">
  ...
  className="mt-4 w-full rounded-xl border border-slate-700 py-4 font-bold hover:bg-slate-800 transition"
>
  Reset
</button>
